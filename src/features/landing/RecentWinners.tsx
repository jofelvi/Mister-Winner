        ...
        <div className="relative container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Conoce a nuestros ganadores más recientes y sus increíbles
              premios. ¡Tú podrías ser el próximo!
            </p>
          </div>

          {/* Skeleton Loading for Winners */}
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[...Array(4)].map((_, index) => (
                <div
                  key={index}
                  className="bg-white/80 backdrop-blur-sm border-2 border-gray-200/50 rounded-xl p-6 animate-pulse"
                >
