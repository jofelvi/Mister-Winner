'use client';
import { Heart, Mail, MapPin, Phone, Shield, Star, Ticket } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 leading-relaxed mb-6 max-w-md">
                La plataforma de rifas más confiable y transparente de
                Venezuela. Participa, gana y disfruta de una experiencia segura
                y emocionante.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#rifas"
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 flex items-center gap-2"
                  >
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3 text-gray-300">
                  ...
                  <span className="text-sm">valencia, Venezuela</span>
                </li>
              </ul>
